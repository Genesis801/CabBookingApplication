...
public class CabServiceTest {
	...
	public void updateCabTest() {
		...
		Cab newcab = new Cab(10001,"mini",25.4f);
		given(cabRepo.findById(10001)).willReturn(Optional.of(cab));
		cabService.updateCab(newcab);
		verify(cabRepo).save(newcab);
		verify(cabRepo).findById(10001);	
	}
